...
class CarWala {
    ...
    private void initializeCarDetails() {
        carDetails.put("Maruti Baleno", 600000.0);
        carDetails.put("Honda Civiv", 900000.0);
        carDetails.put("Toyota Corolla", 1200000.0);
        carDetails.put("Hyundai i20 Sport", 700000.0);
        carDetails.put("Ford Mustang", 3500000.0);
        carDetails.put("Volkswagen Jetta", 800000.0);
        carDetails.put("Nissan Altima", 1100000.0);
        carDetails.put("BMW X5", 5500000.0);
        carDetails.put("Mercedes A-Class", 5000000.0);
        carDetails.put("Audi A6", 5200000.0);
    }
